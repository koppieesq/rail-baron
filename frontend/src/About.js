...
function About() {
    return (<div className="main-content">
            ...
            <p><T>This is a <strong>technology demonstration</strong> to illustrate how to build a sophisticated,
                modern site using headless Drupal, React, and <em>Kubernetes.</em>  This site was originally built for
                <strong>Stanford Web Camp 2026</strong>; you are invited to read Jordan's
                <a href="/presentation/demystifying-kubernetes.html">slide deck.</a></T></p>
            ...
            <p><T>My name is Jordan Koplowicz and I am the sole proprietor of <a href="https://koplowiczandsons.com">
                ...
                that.</T></p>
            <p><T>I invite you to visit my professional site: https://koplowiczandsons.com</T></p>
