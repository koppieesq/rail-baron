 ...
 * @endcode
 */
$settings['hash_salt'] = '0IMTGr7Kccru3uvuPl5X';
 ...
 */
# $settings['file_public_base_url'] = 'https://d10.koplowiczandsons.com';
...
// Production settings (container / Kubernetes).
if (getenv('IS_DDEV_PROJECT') != 'true' && file_exists(__DIR__ . '/settings.production.php')) {
